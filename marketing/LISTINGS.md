...
**Before your first post, do one find-and-replace across this file:**
...
Settings baked into this copy: service area = whole metro/county · no prices shown (free quote) · customers can **call/text OR message**.

> **Facebook Marketplace price field:** Marketplace forces a number. Type `0` — it will display as "Free", which is fine and gets clicks; the body text makes clear it's a free *quote*, not free work. (Alternatively post these in local Facebook community / Buy-Sell-Trade groups, which have no price field.)

---

## 1. Dryer Vent Cleaning

**Category:** Marketplace → Services → Home Improvement
**Title options (pick one, rotate monthly):**
- `Dryer Vent Cleaning – Faster Drying & Fire Prevention | the Treasure Valley`
- `Clogged Dryer Vent? Pro Cleaning – the Treasure Valley & Surrounding Towns`
...
✅ Reduces fire risk
✅ Quick, clean, in-and-out same visit

Free no-pressure quote. Call or text (215) 859-3267, or message me here.
Booking this week — the Treasure Valley and nearby.
```
...
**Category:** Marketplace → Services → Lawn & Garden
**Title options:**
- `Landscaping & Yard Cleanups – the Treasure Valley | Free Quotes`
- `Lawn Care, Mulch, Trimming & Cleanups – Serving the Treasure Valley`
...
🌿 One-time jobs or regular service

Serving the Treasure Valley and surrounding towns. Reliable, show up when we say we will.

Free quote — call/text (215) 859-3267 or message here. Send a photo of the yard for a fast estimate.
```
...
**Category:** Marketplace → Services → Other
**Title options:**
- `Junk Removal & Hauling – Same/Next Day | the Treasure Valley`
- `We Haul It All – Junk Removal Serving the Treasure Valley`
...
🚛 Yard debris & construction junk
🚛 Single item or full truckload
🚛 We do the lifting and loading — you point, it's gone

Same or next-day pickup across the Treasure Valley and nearby towns.

Free quote — call/text (215) 859-3267 or message a photo of the pile here for a fast price.
```
...
**Category:** Marketplace → Services → Home Improvement
**Title options:**
- `Power Washing – Driveways, Siding, Decks | the Treasure Valley`
- `Make It Look New Again – Pressure Washing Serving the Treasure Valley`
...
• DRYER VENT CLEANING — faster drying, lower bills, fire prevention.
• LANDSCAPING — cleanups, mowing, mulch, trimming, brush removal.
• JUNK REMOVAL — furniture, appliances, full cleanouts, same/next day.
• POWER WASHING — siding, driveways, decks, patios, fences.

Why us: reliable scheduling, fair pricing, no mess left behind, free quotes on everything.

📞 Call or text (215) 859-3267
💬 Or message [FB]

Photos of the job get you a price fastest.
```
...
Call/text (215) 859-3267 or message me. Glad to help out around the neighborhood.
```

## Google Business Profile — "Post" (short promo, repost every ~7 days)
...
Use the **exact same titles + bodies as the Facebook Marketplace listings above** — one
post per service. OfferUp's audience overlaps with Marketplace buyers looking for local help.

## Local Facebook community / Buy-Sell-Trade groups
...
## Reddit — r/[yourcity] (read each subreddit's self-promo rules first)
...
or give advice in the comments even if you don't hire out. Call/text (215) 859-3267 or DM.
```
